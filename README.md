...
**Description**: Production-grade document intelligence pipeline for heterogeneous PDFs (digital, scanned, mixed, table-heavy) that preserves provenance end to end.
...
**For more reading**: https://deepwiki.com/eyor-gech/DI_refinery_pipeline_project
